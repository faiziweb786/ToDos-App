                    ...
                    <?php if(isset($items)): ?>
                        <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr id="<?php echo e($dt->id); ?>" class="bg-info">
                                ...
                                <td class="email"><?php echo e(Str::limit($dt->email , 10)); ?></td>
                                <td class="cnic"><?php echo e(Str::limit($dt->cnic , 7)); ?></td>
                                <td class="pnumber"><?php echo e(Str::limit($dt->pnumber , 7)); ?></td>
                                <td class="gender">
                                    <?php if($dt->gender == 'M'): ?>
                                        Male
                                ...
                                <td class="address"><?php echo e(Str::words($dt->address , 2)); ?></td>
                                <td class="d-flex align-items-center">
                                    <button class="edit_btn btn btn-success border border-warning mr-1"
                                        onclick="editPopup()" data-edit-id="<?php echo e($dt->id); ?>">Edit</button>
                                    <button class="btn delete_btn btn-danger border border-warning"
                                        data-id="<?php echo e($dt->id); ?>">Delete</button>
                                </td>
                            </tr>
