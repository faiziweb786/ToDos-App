...
<?php $__env->startSection('h1', 'Dashboard'); ?>
<?php $__env->startSection('li', 'Dashboard'); ?>
    ...
    <div class="row">
        <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
                ...
                <a href="<?php echo e(route('useritem')); ?>" class="small-box-footer">More info <i
        ...
        <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
                <div class="inner">
                    <h3><?php echo e($randNumber); ?><sup style="font-size: 20px">%</sup></h3>
        ...
        <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
                ...
                <a href="<?php echo e(route('viewusers')); ?>" class="small-box-footer text-white">More info <i
                        class="fas fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <!-- ./col -->
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\project\login_registration\resources\views/admin/pages/dashboard.blade.php ENDPATH**/ ?>