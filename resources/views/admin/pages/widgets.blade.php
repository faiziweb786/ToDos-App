        ...
        <div class="row">
            ...
            <div class="card card-widget widget-user-2">
              ...
              <div class="widget-user-header bg-warning">
                <div class="widget-user-image">
                  <img class="img-circle elevation-2" src="{{ asset('admin/img/user7-128x128.jpg') }}" alt="User Avatar">
                </div>
                <!-- /.widget-user-image -->
          ...
          <div class="col-md-4">
            ...
            <div class="card card-widget widget-user">
              ...
              <div class="widget-user-image">
                <img class="img-circle elevation-2" src="{{ asset('admin/img/user1-128x128.jpg') }}" alt="User Avatar">
              </div>
              <div class="card-footer">
                <div class="row">
          ...
          <div class="col-md-4">
            ...
            <div class="card card-widget widget-user">
              ...
              <div class="widget-user-header text-white"
                   style="background: url('{{ asset('admin/img/photo1.png') }}') center center;">
                <h3 class="widget-user-username text-right">Elizabeth Pierce</h3>
                <h5 class="widget-user-desc text-right">Web Designer</h5>
              </div>
              <div class="widget-user-image">
                <img class="img-circle" src="{{ asset('admin/img/user3-128x128.jpg') }}" alt="User Avatar">
              </div>
              <div class="card-footer">
                <div class="row">
                  <div class="col-sm-4 border-right">
            ...
            <div class="card card-widget">
              <div class="card-header">
                <div class="user-block">
                  <img class="img-circle" src="{{ asset('admin/img/user1-128x128.jpg') }}" alt="User Image">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <img class="img-fluid pad" src="{{ asset('admin/img/photo2.png') }}" alt="Photo">
              ...
              <div class="card-footer card-comments">
                <div class="card-comment">
                  <!-- User image -->
                  <img class="img-circle img-sm" src="{{ asset('admin/img/user3-128x128.jpg') }}" alt="User Image">
                ...
                <div class="card-comment">
                  <!-- User image -->
                  <img class="img-circle img-sm" src="{{ asset('admin/img/user4-128x128.jpg') }}" alt="User Image">
              ...
              <div class="card-footer">
                <form action="#" method="post">
                  <img class="img-fluid img-circle img-sm" src="{{ asset('admin/img/user4-128x128.jpg') }}" alt="Alt Text">
            ...
            <div class="card card-widget">
              ...
              <div class="card-body">
                ...
                <div class="attachment-block clearfix">
                  <img class="attachment-img" src="{{ asset('admin/img/photo1.png') }}" alt="Attachment Image">
              ...
              <div class="card-footer card-comments">
                ...
                <div class="card-comment">
                  <!-- User image -->
                  <img class="img-circle img-sm" src="{{ asset('admin/img/user5-128x128.jpg') }}" alt="User Image">
