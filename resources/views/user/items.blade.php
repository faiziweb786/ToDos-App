                ...
                <div class="modal-body">
                    ...
                    <form id="addForm">
                        ...
                        <div class="row pt-4">
                            ...
                            <x-select name="religion" id="religion" value="">
                                <x-option value="">Select Religion</x-option>
                                <x-option value="muslim">Muslim</x-option>
                                <x-option value="non-muslim">Non-Muslim</x-option>
                            </x-select>
                ...
                <div class="modal-body">
                    ...
                    <form id="editForm">
                        ...
                        <div class="row pt-4">
                            ...
                            <x-select name="religion" id="edit_religion" value="">
                                <x-option value="">Select Religion</x-option>
                                <x-option value="muslim">Muslim</x-option>
                                <x-option value="non-muslim">Non-Muslim</x-option>
                            </x-select>
